...
$(function () {
    ...
    describe('The menu', function () {
        ...
        it("is hidden", function () {
            let menuHidden = menu.classList.contains('menu-hidden');
    ...
    describe('Initial Entries', function () {
        ...
        it('can display one .entry within .feed', function (done) {
            let content = document.querySelector('.feed').querySelectorAll('.entry');
